            ...
            <div class="col-lg-8">
                <div class="blog_left_sidebar">
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="{{asset('front-master/img/blog/main-blog/m-blog-1.jpg')}}" alt="">
                                <div class="blog_details">
                                    <a href="{{url('/detail-blog')}}"><h2>Astronomy Binoculars A Great Alternative</h2></a>
                                    <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                    <a href="{{url('/detail-blog')}}" class="primary_btn"><span>View More</span></a>
                                </div>
                            </div>
                        </div>
                    </article>
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="{{asset('front-master/img/blog/main-blog/m-blog-2.jpg')}}" alt="">
                                <div class="blog_details">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="{{asset('front-master/img/blog/main-blog/m-blog-3.jpg')}}" alt="">
                                <div class="blog_details">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="{{asset('front-master/img/blog/main-blog/m-blog-4.jpg')}}" alt="">
                                <div class="blog_details">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="{{asset('front-master/img/blog/main-blog/m-blog-5.jpg')}}" alt="">
                                <div class="blog_details">
